...
#SBATCH --job-name=20210924_vast_align_combine
#SBATCH --output=20210924_vast_align_combine_output.txt
...
for file in /scratch/n/nprovart/khanha55/R1_for_later/*.gz; do
